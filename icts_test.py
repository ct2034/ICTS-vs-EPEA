...
map_details1 = MapDetails("results/icts_test.txt",
                          file_name, my_map, starts, goals)

no_solutions = "instances/no_solution.txt"
my_map, starts, goals = map_utils.import_mapf_instance(no_solutions)
map_details2 = MapDetails("results/icts_test.txt",
                          no_solutions, my_map, starts, goals)


def test_find_most_optimal_paths():
    icts = ICTSSolver(map_details1)
    optimal_paths = icts.find_most_optimal_paths()
    assert optimal_paths == [[(1, 1), (1, 2), (1, 3), (1, 4), (1, 5)], [(
        1, 2), (1, 3), (1, 4)]], "Cannot find most optimal paths of a map instance"
...
def test_find_most_optimal_cost_of_paths():
    ...
    assert cost_of_optimal_paths == [
        4, 2], "Cannot find cost of most optimal paths of a map instance"
...
def test_create_initial_cost_for_ict():
    ...
    assert root_costs == [
        4, 2], "Cost of the root node of the ict is incorrect"
...
def test_number_of_open_spaces():
    number_of_open_spaces = map_utils.find_number_of_open_spaces(
        map_details2.map_instance)
